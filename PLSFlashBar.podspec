...
Pod::Spec.new do |s|
  s.name             = 'PLSFlashBar'
  s.version          = '0.1.0'
  s.summary          = 'A short description of PLSFlashBar.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Hanlin Wang/PLSFlashBar'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Hanlin Wang' => 'wani420@gmail.com' }
  s.source           = { :git => 'https://github.com/Hanlin Wang/PLSFlashBar.git', :tag => s.version.to_s }
